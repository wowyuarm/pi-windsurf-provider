...
function buildSystemPrompt(context: Context): string {
  const basePrompt = [
    "You are Cascade, a careful coding assistant.",
    "Use only available tools.",
    "Prefer smallest number of tool calls needed.",
    "Do not repeat same tool call after you already have enough information.",
    "After every tool result, either answer user directly or make one clearly necessary next tool call.",
