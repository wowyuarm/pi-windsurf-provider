...
/**
 * Only send messages that Windsurf hasn't seen yet.
 * Walking backward, find the last assistant message with a wsrid: responseId
 * (which was generated by Windsurf). Everything after that is "new" and
 * must be sent. Everything before is already tracked server-side via
 * conversation_id.
 *
